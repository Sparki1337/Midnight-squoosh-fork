  ...
  render(
    ...
    return (
      ...
      >
              ...
              <h3 class={style.optionsTitle}>
                <div class={style.titleAndButtons}>
                  ...
                  <button
                    ...
                    title="Копировать настройки на другую сторону"
                  ...
                  <button
                    ...
                    title="Импортировать сохраненные настройки"
        ...
        <h3 class={style.optionsTitle}>Сжатие</h3>
        ...
        <section class={`${style.optionOneCell} ${style.optionsSection}`}>
          {supportedEncoderMap ? (
            <Select
              ...
              large
            >
              <option value="identity">{`Исходное изображение ${
