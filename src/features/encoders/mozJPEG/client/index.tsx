          ...
          {showAdvanced ? (
            <div>
              <label class={style.optionTextFirst}>
                ...
                >
                  <option value={MozJpegColorSpace.GRAYSCALE}>Оттенки серого</option>
                ...
                {options.color_space === MozJpegColorSpace.YCbCr ? (
                  <div>
                    <label class={style.optionToggle}>
                      Авто субсемплирование цветности
                      <Checkbox
                        name="auto_subsample"
                      ...
                      {options.auto_subsample ? null : (
                        <div class={style.optionOneCell}>
                          <Range
                            ...
                            onInput={this.onChange}
                          >
                            Субсемплировать цветность на:
                          </Range>
                        </div>
                      )}
                    </Expander>
                    <label class={style.optionToggle}>
                      Раздельное качество цветности
                      <Checkbox
              ...
              <label class={style.optionToggle}>
                Бесполезное соответствие спецификации
                <Checkbox
                  name="baseline"
              ...
              <Expander>
                {options.baseline ? (
                  <label class={style.optionToggle}>
                    Оптимизировать таблицу Хаффмана
                    <Checkbox
              ...
              <label class={style.optionTextFirst}>
                ...
                >
                  ...
                  <option value="1">Плоская</option>
                  <option value="2">MSSIM-настроенная Kodak</option>
                  <option value="3">ImageMagick</option>
                  <option value="4">PSNR-HVS-M-настроенная Kodak</option>
                  <option value="5">Klein и др.</option>
                  <option value="6">Watson и др.</option>
                  <option value="7">Ahumada и др.</option>
                  <option value="8">Peterson и др.</option>
                </Select>
              </label>
              <label class={style.optionToggle}>
                Многопроходная обработка Trellis
                <Checkbox
              ...
              <label class={style.optionToggle}>
                Оптимизировать после квантизации Trellis
                <Checkbox
