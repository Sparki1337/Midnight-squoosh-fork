    ...
    return (
      ...
      >
        <label class={style.optionTextFirst}>
          ...
          >
            {isVector && <option value="vector">Вектор</option>}
            <option value="lanczos3">Lanczos3</option>
            <option value="mitchell">Mitchell</option>
            <option value="catrom">Catmull-Rom</option>
            <option value="triangle">Треугольный (билинейный)</option>
            <option value="hqx">hqx (пиксельная графика)</option>
            <option value="browser-pixelated">Браузерный пикселизированный</option>
            <option value="browser-low">Браузерное низкое качество</option>
            <option value="browser-medium">Браузерное среднее качество</option>
            <option value="browser-high">Браузерное высокое качество</option>
          </Select>
        </label>
        <label class={style.optionTextFirst}>
          Предустановка:
          ...
          {maintainAspect ? null : (
            <label class={style.optionTextFirst}>
              ...
              >
                ...
                <option value="contain">Содержать</option>
              </Select>
            </label>
          )}
        </Expander>
