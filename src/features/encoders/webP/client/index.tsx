    ...
    return (
      <div key="lossless">
        ...
        <label class={style.optionToggle}>
          Дискретное тональное изображение
          {/*
            ...
            <div>
              ...
              <div class={style.optionOneCell}>
                <Range
                  ...
                  onInput={this.onChange}
                >
                  Альфа фильтр качество:
                </Range>
              </div>
              <label class={style.optionToggle}>
                Авто настройка силы фильтра
                <Checkbox
                  name="autofilter"
    ...
    return (
      <form class={style.optionsSection} onSubmit={preventDefault}>
        <div class={style.optionToggle}>
          <i>Переключаясь между Lossy и Lossless, некоторые настройки могут быть сброшены к значениям по умолчанию.</i>
        </div>
        <label class={style.optionToggle}>
          Без потерь (Lossless)
          <Checkbox
        ...
        <div class={style.optionOneCell}>
          <Select
            ...
            onChange={this.onChange}
          >
            <option value="0">Без предварительной обработки</option>
            <option value="1">Сегментированный</option>
            <option value="2">Эвристический</option>
          </Select>
        </div>
      </form>
    );
